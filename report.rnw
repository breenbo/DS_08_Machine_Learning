...
The \emph{Bagging CART model} is especially interesting because of its small computation time, \Sexpr{round(plotsAccu$Time[5],0)} seconds, in comparaison of the \Sexpr{round(plotsAccu$Time[1], 0)} seconds for the C5.0 model.
